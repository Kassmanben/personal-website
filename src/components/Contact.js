  ...
  return (
    <div className="contact">
      ...
      <ul className="contact-list">
        <li>
          <a href="https://www.instagram.com/kassman_ben/?hl=en">
            <svg
        ...
        <li>
          <a href="mailto:me@kassmanben.com">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="-2 -5 24 24"
              width="24"
        ...
        <li>
          <a href="https://www.twitter.com/kassman_ben/">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="-2 -4 24 24"
              width="24"
        ...
        <li>
          <a href="https://www.linkedin.com/in/ben-kassman/">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              viewBox="-2 -2 24 24"
              width="24"
